...
export function renameQuestion(question: Question, newName: string): Question {
    ...
    renamed.options = [...question.options];
    return renamed;
}
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    ...
    dupe.options = [...oldQuestion.options];
...
export function addOption(question: Question, newOption: string): Question {
    const newQ = { ...question };
    newQ.options = [...question.options, newOption];
    return newQ;
}
...
export function mergeQuestion(
    ...
    const mergeQ = { ...contentQuestion };
    mergeQ.id = id;
    mergeQ.name = name;
    mergeQ.points = points;
    mergeQ.options = [...contentQuestion.options];
    mergeQ.published = false;
    return mergeQ;
}
